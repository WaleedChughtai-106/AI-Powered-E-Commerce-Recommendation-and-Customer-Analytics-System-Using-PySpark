      ...
      <div className="mt-6 grid gap-4 grid-cols-1 lg:grid-cols-3">
        <InsightCard title="Account Settings" icon={User} className="lg:col-span-2">
          <div className="mb-6 flex items-center gap-4">
            ...
            <button className="rounded-lg bg-surface-2 px-3 py-1.5 text-xs font-semibold hover:bg-surface-3 transition">
              Change Photo
            </button>
          </div>
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2 border-t border-white/[0.06] pt-5">
            <div>
              ...
              <input
                ...
                value={userEmail}
                readOnly
                className="h-10 w-full rounded-lg border border-white/[0.06] bg-surface-1 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
              />
            </div>
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  defaultValue="••••••••••••"
                  readOnly
                  className="h-10 w-full rounded-lg border border-white/[0.06] bg-surface-1 pl-3 pr-9 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
                />
        ...
        >
          ...
          <div className="mt-5 rounded-xl border border-violet-500/20 bg-violet-500/5 p-4">
            <p className="text-sm italic leading-relaxed">
              ...
              industry average for enterprise analytics. MFA is protecting{" "}
              <span className="font-semibold">3 active sessions</span>."
            </p>
          </div>
